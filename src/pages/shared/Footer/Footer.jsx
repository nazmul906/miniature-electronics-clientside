...
const Footer = () => {
  return (
    <footer className="bg-blue-400 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap">
          <div className="w-full md:w-1/2 lg:w-1/4 mb-4 md:mb-0">
            <h3 className="text-lg font-bold mb-2">Electronic Miniature</h3>
          ...
          <div className="w-full md:w-1/2 lg:w-1/4">
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-indigo-500 text-white px-4 py-2 rounded-r-lg transition-colors duration-300 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                Subscribe
              </button>
            </form>
      ...
      <div className="bg-blue-400 py-4 mt-2">
